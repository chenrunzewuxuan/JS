...
gulp.task('uglify',function(){
	gulp.src(['src/js/**/*.js','src/libs/**/*.js'])
    .pipe(plumber())
	.pipe(uglify())
...
gulp.task('servers',function(){
    ...
    gulp.watch(['src/js/**/*.js','src/libs/**/*.js'],['uglify']);
    gulp.watch('src/css/**/*.scss',['cssnano']);
    gulp.watch(['src/images/**/*.jpg','src/images/**/*.png','src/images/**/*.ico'],['imagemin']);

}); 


gulp.task('default',['minify','cssnano','imagemin','servers']);
